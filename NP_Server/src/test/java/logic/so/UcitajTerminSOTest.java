...
public class UcitajTerminSOTest {
    ...
    public void testExecuteOperation() throws Exception {
       ...
       Termin testTermin = new Termin( new Salon(2L), 2L, "11:15", new Date(2024,10,10), "Petko", true, new Korisnik(1), new Usluga(1));
        ...
        ucitajTerminSO.execute(testTermin);

        OpstiDomenskiObjekat result = (OpstiDomenskiObjekat) ucitajTerminSO.getResult();
